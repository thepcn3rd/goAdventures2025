...
The DNS server works well for internal requests; however, my wireless system proxies DNS requests, preventing identification of the specific client making a request. Despite this limitation, the server successfully supports TLS certificate validation for my SSL reverse proxy in front of the Guacamole server.
