...
class BurpExtender(IBurpExtender, ITab, IContextMenuFactory):
    ...
    def registerExtenderCallbacks(self, callbacks):
        ...
        labels = ["Queue Server:", "API Key:", "Ollama URL:", "Model:"]
        ...
        self._textFields[3].setText("") # Model
    ...
    def handleLoadConfig(self, event):
        try:
            ...
            self._textFields[3].setText(modelString)
    ...
    def handleSubmit(self, event):
        try:
            ...
            apiKeyText = self._textFields[1].getText().strip() 
            modelText = self._textFields[3].getText().strip()  
