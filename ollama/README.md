...
class Tools:
    ...
    def get_f1(self, ipaddr: str) -> str:
        """
        Is this IP Address potentially malicious.
        :param ipaddr: The IP Address to evaluate
        """

        url = "http://10.27.20.174:8080/f1?ipaddress=" + ipaddr
...
In case you would like the code above, here it is.  Also it is contained within the folder where this README.md file is located.
```go
package main
