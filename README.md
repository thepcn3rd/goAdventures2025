...
[SMTP TLS Client](/smtpTLSClient/main.go) - Enhanced the previous version that I wrote [here](https://github.com/thepcn3rd/goAdventures/blob/main/archive/smtpSendEmails.go) and added options in a config.json file to formulate the email and settings.  Then configured it to use SMTP TLS and tested with gmail.
